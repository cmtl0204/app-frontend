...
@Component({
    selector: 'app-state-career',
    imports: [
        FormField
    ],
    templateUrl: './state-career.component.html'
})
export class StateCareerComponent implements OnInit, OnDestroy {
    ...
    protected readonly stateCareerForm: FieldTree<StateCareer> = this.buildForm;
    ...
    ngOnInit(): void {
        this.formRegistryService.register(
            'stateCareerForm',
            this.stateCareerForm,
            this.form$()
        );
    }

    ngOnDestroy(): void {
        this.formRegistryService.unregister('stateCareerForm');
    }
